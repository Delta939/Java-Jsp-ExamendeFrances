...
<form action="/examen/controlador" method="post" >
	prenom:<input type="text" name="nombre" >  nom:<input type="text" name="apellidopaterno" ><br> 
	nom de famille maternelle:<input type="text" name="apellidomaterno" > étudiant clef:<input type="text" name="matricula" >
	<br><br>
